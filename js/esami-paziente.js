window.ESAMI_PAZIENTE = {
  'addome-completo': {
    ...
    svolgimento:
      'Ti sdrai sul lettino. Si passa un gel freddo sulla pancia e si muove la sonda senza dolore. A volte ti chiederanno di trattenere un po’ il respiro. Dura in genere 15–20 minuti.',
    cosaControlla:
  ...
  'addome-superiore': {
    ...
    svolgimento:
      'Sei disteso supino. Gel sulla pelle e sonda che scorre sulla parte alta della pancia. Non fa male; a volte serve trattenere il respiro qualche secondo.',
    cosaControlla:
  ...
  'addome-inferiore': {
    ...
    svolgimento:
      'Ti sdrai e si applica il gel sul basso ventre. La sonda passa sopra la vescica e la zona pelvica. L’esame è indolore.',
    cosaControlla:
  ...
  'apparato-urinario': {
    ...
    svolgimento:
      'Prima si guarda con la vescica piena; poi, se serve, ti chiederemo di urinare e si controlla quanta urina resta in vescica. Gel sulla pancia o sul fianco, senza dolore.',
    cosaControlla:
  ...
  renale: {
    ...
    svolgimento:
      'Ti sdrai supino o di lato. Gel su fianco e schiena, sonda che passa sui reni. Non è dolorosa.',
    cosaControlla:
  ...
  'vescico-prostatica': {
    ...
    svolgimento:
      'È importante arrivare con la vescica abbastanza piena. Ti sdrai, gel sul basso ventre, sonda sopra il pube. L’esame non fa male.',
    cosaControlla:
  ...
  'scrotale-testicolare': {
    ...
    svolgimento:
      'Ti sdrai. Si applica gel sullo scroto e si passa la sonda delicatamente. In genere non fa male; in caso di dolore acuto va segnalato subito.',
    cosaControlla:
  ...
  tiroide: {
    ...
    svolgimento:
      'Ti sdrai con il collo leggermente all’indietro. Gel sul collo, sonda che scorre sulla tiroide. Non fa male e dura pochi minuti.',
    cosaControlla:
  ...
  'muscolo-scheletrica': {
    ...
    svolgimento:
      'Si mette gel sulla zona interessata. A volte ti chiederemo di muovere l’arto mentre guardiamo lo schermo. Non è dolorosa se fatta con calma.',
    cosaControlla:
  ...
  anca: {
    ...
    svolgimento:
      'Gel su inguine, fianco o entrambi, a seconda del dolore. Muovi l’anca se necessario. Esame indolore.',
    cosaControlla:
  ...
  'anca-neonatale': {
    ...
    svolgimento:
      'Il bambino resta disteso o in braccio al genitore. Si passa una sonda piccola sulle anche, con gel. Non fa male al neonato.',
    cosaControlla:
  ...
  gomito: {
    ...
    svolgimento:
      'Gomito appoggiato o disteso, gel sulla pelle, sonda che esplora la zona dolente. Non dolorosa.',
    cosaControlla:
  ...
  'polso-mano': {
    ...
    svolgimento:
      'Mano e polso appoggiati, gel sulla pelle. A volte pieghi o estendi le dita. Esame indolore.',
    cosaControlla:
  ...
  'caviglia-piede': {
    ...
    svolgimento:
      'Piede e caviglia con gel; a volte piccoli movimenti del piede. Non fa male.',
    cosaControlla:
  ...
  'parti-molli': {
    ...
    svolgimento:
      'Gel sulla zona del gonfiore, sonda che passa sopra. Indolore; dura pochi minuti.',
    cosaControlla:
  ...
  'doppler-tsa': {
    ...
    svolgimento:
      'Ti sdrai. Si passa gel sul collo e si usa la sonda Doppler: puoi sentire un suono simile al battito. Non fa male.',
    cosaControlla:
  ...
  'doppler-aorta': {
    ...
    svolgimento:
      'Disteso supino, gel sulla pancia. La sonda Doppler mostra il flusso del sangue nell’aorta. Esame indolore.',
    cosaControlla:
  ...
  'doppler-arterie-renali': {
    ...
    svolgimento:
      'Ti sdrai, gel su fianco e pancia. Sonda Doppler sui reni: sentirai il suono del flusso. Non dolorosa.',
    cosaControlla:
  ...
  'doppler-arti-inferiori': {
    ...
    svolgimento:
      'Ti sdrai. Gel su gambe e piedi, sonda Doppler che segue arterie o vene. Puoi sentire un suono; non fa male.',
    cosaControlla:
  ...
  'doppler-arti-superiori': {
    ...
    svolgimento:
      'Braccio appoggiato, gel e sonda Doppler lungo arterie e vene. Indolore.',
    cosaControlla:
  ...
  linfonodi: {
    ...
    svolgimento:
      'Gel sulla zona del linfonodo (collo, ascella o inguine), sonda che passa sopra. Non fa male.',
    cosaControlla:
